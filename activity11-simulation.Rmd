...
```{r summary statistics for norm_samp_1000}
...
```{r creating a new sample}
set.seed(518)
norm_samp_30 <- rnorm(30, 50, 10)
mean(norm_samp_30)
sd(norm_samp_30)
```
The standard deviation hasn't changed much, but the accuracy of the mean is slightly worse.
